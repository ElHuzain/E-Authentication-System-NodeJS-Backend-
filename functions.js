...
function getBrowser(userAgent) {
    // Use a regular expression to extract the browser information from the user-agent string
...
function getOperatingSystem(userAgent) {
    // Use a regular expression to extract the operating system information from the user-agent string
...
module.exports = { storeDocument, connect, getDatabase, encrypt, generateId, generateKey, generateRandomNumbers, getBrowser, getOperatingSystem, getIPAddress}